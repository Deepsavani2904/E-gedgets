           ...
           <div className="main-parent">
                <div className="dashboard">
                    ...
                    <ul className='p-0'>
                    {
                        check == 'admin'?
                        <>
                             <NavLink to='/addUser' className='link '  activeClassName="active"> <li><h5 className="m-0"><CgProfile  className='main-icon-h5'/><span>User</span></h5> </li></NavLink>
                        ...
                        :
                        <>
                           <NavLink to='/userbuyProduct' className='link '  activeClassName="active"><li><h5 className="m-0"><BsCartDash  className='main-icon-h5'/><span>User Buy Product</span></h5> </li></NavLink>
